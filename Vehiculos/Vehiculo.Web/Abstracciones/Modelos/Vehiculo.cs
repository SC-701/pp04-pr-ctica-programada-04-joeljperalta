...
namespace Abstracciones.Modelos
{
    public class VehiculoBase
    {
        ...
        [RegularExpression(@"^[A-Za-z]{3}-\d{3}$", ErrorMessage = "El formato debe ser ABC-123")]
        public string Placa { get; set; }



        [Required(ErrorMessage = "La propiedad color es requerida")]
        [StringLength(40, ErrorMessage = "La propiedad color debe ser mayor a 4 carecteres y menos a 40", MinimumLength = 4)]
